defmodule Perkle.Eth do
  @moduledoc """
  Eth Namespace for Perkle JSON-RPC
  RPC calls
  """
  ...
  @doc """
  Get balance of Perkle account by hash
  ...
  @doc """
  Get current sync status of Perkle node
  ...
  @doc """
  Get coinbase address for Perkle node
  ...
  @doc """
  Get current mining status for Perkle node
  ...
  @doc """
  Get current hashrate of Perkle network
