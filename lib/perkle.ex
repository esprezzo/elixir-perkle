defmodule Perkle do
  @moduledoc """
  This library presents a convenient interface to control a full Perkle node from Elixir, 
  ...
  alias Perkle.Eth
  alias Perkle.Net
  alias Perkle.Personal
  alias Perkle.Aggregates
  alias Perkle.HexUtils
  alias Perkle.ABI
